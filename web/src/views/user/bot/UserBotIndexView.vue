                        ...
                        <div class="modal-dialog modal-xl" >
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="botadd.description" class="form-control" id="add-bot-description" rows="3">请简要描述一下你的Bot</textarea>
                                </div>
                                <div class="mb-3">
                            ...
                            <tr v-for="bot in bots" :key="bot.id">
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog modal-xl" >
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <label for="update-bot-title" class="form-label">Bot名称</label>
                                                <input v-model="bot.title" type="text" class="form-control" id="update-bot-title" placeholder="请输入Bot名称">
                                            </div>
                                            <div class="mb-3">
                                                <label for="update-bot-description" class="form-label">Bot的描述</label>
                                                <textarea v-model="bot.description" class="form-control" id="update-bot-description" rows="3">请简要描述一下你的Bot</textarea>
                                            </div>
                                            <div class="mb-3">
...
export default {
    ...
    setup () {
        ...
        const refresh_bots = () => {
            $.ajax({
                url: "https://app5379.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "get",
                headers: {
        ...
        const add_bot = () =>{
            ...
            $.ajax({
                url: "https://app5379.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const remove_bot = (bot) =>{
            botadd.error_message = "";
            $.ajax({
                url: "https://app5379.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app5379.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id : bot.id,
                    title: bot.title,
